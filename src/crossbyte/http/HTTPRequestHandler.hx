...
class HTTPRequestHandler extends EventDispatcher {
    ...
    private function dispatchResponse(statusCode:Int, statusMessage:String, headers:Array<URLRequestHeader>, contentType:String, content:String, headOnly:Bool = false):Void {
